...
import { sampleWithRequiredData } from '../agendamiento.test-samples';
...
describe('Agendamiento Management Component', () => {
  let comp: AgendamientoComponent;
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.agendamientos?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to agendamientoService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getAgendamientoIdentifier');
      const id = comp.trackId(entity);
      expect(service.getAgendamientoIdentifier).toHaveBeenCalledWith(entity);
